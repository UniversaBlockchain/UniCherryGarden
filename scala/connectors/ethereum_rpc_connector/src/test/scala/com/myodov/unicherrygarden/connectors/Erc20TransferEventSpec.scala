...
import com.myodov.unicherrygarden.connectors.Erc20TransferEvent.TopicParseResult
import org.scalatest.flatspec.AnyFlatSpec

class Erc20TransferEventSpec extends AnyFlatSpec {
  ...
  "Log topics" should "be parseable when contain actual Transfer event" in {
    assertResult(
      ...
      Erc20TransferEvent.parseTopics(List(
        "0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef",
