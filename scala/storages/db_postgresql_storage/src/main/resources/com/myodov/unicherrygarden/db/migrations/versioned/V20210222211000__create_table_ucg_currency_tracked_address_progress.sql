CREATE TABLE ucg_currency_tracked_address_progress
(
    id                       BIGINT  NOT NULL GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    currency_id              INTEGER NOT NULL REFERENCES ucg_currency,
    tracked_address_id       BIGINT  NOT NULL REFERENCES ucg_tracked_address,
...
CREATE INDEX IF NOT EXISTS ucg_currency_tracked_address_tracked_address_id
    ON ucg_currency_tracked_address_progress (tracked_address_id);
