...
public interface Receiver {
     ...
     * or {@link #startTrackingAddress(String, StartTrackingAddressMode, String)} for your purposes.
     *
    ...
    default boolean startTrackingAddressFromBlock(@NonNull String address,
        ...
        return startTrackingAddress(address, StartTrackingAddressMode.FROM_BLOCK, blockNumber, comment);
    }
     ...
     *                You should pass any modes except {@link StartTrackingAddressMode#FROM_BLOCK}
