...
public class EthUtilsUint256StrTest {
    ...
    public void testToAddress() {
        assertEquals("Should work well with proper address",
        ...
        assertThrows("Should fail if the hex string contains non-zeroes in high bytes",
    ...
    public void testFromAddress() {
        ...
        assertThrows("Should fail if the hex string is anything but non-hex",
                IllegalArgumentException.class,
                () -> EthUtils.Uint256Str.fromAddress(" 0xd701edf8f9c5d834bcb9add73ddeff2d6b9c3d")
        );
        assertThrows("Should fail if the hex string is valid address of wrong length",
                IllegalArgumentException.class,
                () -> EthUtils.Uint256Str.fromAddress("0xd701edf8f9c5d834bcb9add73ddeff2d6b9c3d2")
        );
        assertThrows("Should fail even if the hex string is not lowercased",
                IllegalArgumentException.class,
                () -> EthUtils.Uint256Str.fromAddress("0xD701edf8f9c5d834bcb9add73ddeff2d6b9c3d24")
        );
    }
    ...
    public void testToBigInteger() {
        assertEquals("Should work well with proper number",
