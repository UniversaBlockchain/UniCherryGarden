...
The packages are being built and published to Sonatype Central repository, so most of the times you can use in the Java build tool of your choice very easily. For example, if the currently published version is **0.9.4**, you can use this package in the following way:
...
~~~gradle
implementation group: 'com.myodov.unicherrygarden', name: 'cherrygardener_connector', version: '0.9.4'
~~~

#### sbt

~~~sbt
libraryDependencies += "com.myodov.unicherrygarden" % "cherrygardener_connector" % "0.9.4"
~~~

#### ivy

~~~ivy
<dependency org="com.myodov.unicherrygarden" name="cherrygardener_connector" rev="0.9.4"/>
~~~
